...
module.exports = {
  ...
  products: [
    ...
    },
    {
      ...
      price: 0,
      points: 30,
      pointsDisplay: '30 Caixapoints',
      qualifyingPoints: 30,
      nonQualifyingPoints: 0,
      image: 'compra4.png',
      description: 'Convierte tu operación en una donación solidaria a la Fundación "la Caixa".',
      category: 'donation',
      isPremium: false,
      digitalOnly: true,
      journalType: 'Redemption',
    ...
    },
    {
      ...
      price: 0,
      points: 40,
      pointsDisplay: '40 Caixapoints',
      qualifyingPoints: 40,
      nonQualifyingPoints: 0,
      image: 'compra5.png',
      description: 'Crea tarjetas virtuales temporales para compras online ultra seguras.',
      category: 'digital_banking',
      isPremium: false,
      digitalOnly: true,
      journalType: 'Accrual',
